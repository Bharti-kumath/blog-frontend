      ...
      <form className="writeform" onSubmit={handlesubmit}>
        ...
        <label className="writeinput cat">
          ...
          >
            ...
            <option className="catoption" value="Yoga">Yoga</option>
            <option className="catoption" value="Exercises">Exercises</option>
            <option className="catoption" value="Education">Education</option>
            <option className="catoption" value="Electronics">Electronics</option>
            <option className="catoption" value="Relationships">Relationships</option>
            <option className="catoption" value="Music">Music</option>
